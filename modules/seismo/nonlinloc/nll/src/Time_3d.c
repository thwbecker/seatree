...
/*    (float *)      HS,T : 1-D arrays. Length: NX*NY*NZ                      */
...
/*    (float)    XS,YS,ZS : real point source coordinates, i.e. distances     */
...
static void
    error(/* int */),
    init_nearest(/* void */),
    init_cell(/* int,int,int,int,int,int */),
    free_ptrs(/* int */);
...
int
time_3d(HS,T,NX,NY,NZ,XS,YS,ZS,HS_EPS_INIT,MSG)

float *HS,*T,HS_EPS_INIT,XS,YS,ZS;
int   NX,NY,NZ,MSG;
