...
c	if xi=[-tol,tol] and eta=[-tol,tol], where tol=1+eps.
c
...
c.... error handling
c
999	call error ("prj4q   ", 
     &	    "('Zero determanent of Jacobian; element',i5)", iel)
c
c.... end
c
	end
