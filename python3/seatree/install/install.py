...
import os, sys, xml.dom.minidom, subprocess, shutil, traceback, importlib
...
class SEATREEInstaller:
    ...
    def checkConvert(self):
        ...
        while True:
            response = input("Path to convert (default: " + self.convertPath + "): ")
    ...
    def createExecutable(self):
        ...
        response = input("Link to 'seatree' executable from /usr/bin/seatree? (y/n default: y)? ")
